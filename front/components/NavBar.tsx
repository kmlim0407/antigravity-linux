                ...
                <AnimatePresence mode="wait">
                  {scrolled ? (
                    <motion.button
                      ...
                      type="button"
                      onClick={scrollToTop}
                      className="flex h-12 w-12 shrink-0 cursor-pointer items-center justify-center rounded-lg text-[2.15rem] font-bold text-slate-700 transition-colors hover:bg-slate-100 hover:text-slate-900 sm:h-14 sm:w-14 sm:text-[2.4rem]"
                      aria-label="맨 위로"
                      initial={{ opacity: 0 }}
                      animate={{
                  ...
                  >
                    <Link
                      href="/"
                      className="text-2xl font-bold uppercase tracking-[-0.08em] sm:text-3xl md:text-4xl"
